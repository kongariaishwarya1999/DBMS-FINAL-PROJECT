...
ALTER TABLE stock ADD CONSTRAINT fk_stock FOREIGN KEY(prodid) REFERENCES product(prodid) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE stock ADD CONSTRAINT fk_stock_depot FOREIGN KEY(depid) REFERENCES depot(depid) ON DELETE CASCADE ON UPDATE CASCADE;
